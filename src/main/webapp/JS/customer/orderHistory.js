$(document).ready(function(){
	...
	$("#historyGrid").jqGrid({
		...
		colModel: [
			{ name: 'quotationId', index: 'quotationId', width:'100' },
			{ name: 'orderId', index: 'orderId',width:'100' },
			{ name: 'supplierId', index: 'supplierId', width:'105' },
			...
			{ name: 'chat', index: 'chat', editable: false, formatter: chatFormatter, frozen:true, width: '180'  },
...
function loadConfirmOrderData(quotationId, orderId, supplierId) {
	...
	$("#orderLineGrid").jqGrid({
		...
		colModel: [
			...
			{ name: 'orderedQty', index: 'orderedQty', sorttype: "int", width: '100'},
			{ name: 'quotationStatus', index: 'quotationStatus', hidden: true },
			{ name: 'orderedPrice', index: 'orderedPrice', width: '150' },
		],
