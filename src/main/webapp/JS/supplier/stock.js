...
$(document).ready(function(){
	...
	$("#stockPageLI").addClass('menu-item-here');
	...
	$("#stockGrid").jqGrid({
		...
		rowNum: 100,
		rowList: [100, 200, 500],
		colNames: ['Line No', 'Pip Code', 'Product','Supplier Id','Brand', 'Quantity','Price', 'Expiry Date',  'Actions'],
		colModel: [
			...
			{ name: 'action', index: 'action', align: "center", editable: false, formatter: actionFormatter,  frozen: true  },
		],
...
//		cellurl: 'updateStock',
	...
	$("#stockGrid").jqGrid('setLabel','rn','#','setFrozenColumns');
