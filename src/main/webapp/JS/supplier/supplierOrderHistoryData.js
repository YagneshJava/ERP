$(document).ready(function(){
	...
	$('#historySrchMain').keyup(function(event) {
			jQuery("#historyGrid").jqGrid('setGridParam', {
					...
					url : 'orderHistoryFilter?customerId=' + $("#supplierId").val()+
...
function getOrderHistory(){
	...
	$("#historyGrid").jqGrid({
		...
		colModel: [
			{ name: 'quotationId', index: 'quotationId', width:'103' ,hidden:true},
			{ name: 'orderId', index: 'orderId',width:'72' },
			{ name: 'supplierId', index: 'supplierId', width:'92',hidden:true },
			...
			{ name: 'chat', index: 'chat', align: "center", editable: false, formatter: chatFormatter, frozen:true,width:'200'  },
...
function loadHistoryConfirmOrderData(quotationId, orderId, manufacturerId) {
