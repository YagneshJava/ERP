...
$(document).ready(function(){
	...
	$("#manufacturerPriceListPageLI").addClass('menu-item-here');
...
//		cellurl: 'updatePrice',
	...
	$("#MakeOfferModal").on("hidden.bs.modal", function() {
		$('#offerForm')[0].reset();
		$('tr').removeClass('not-editable-row');
	});
	...
	$('#offersDateRangePickerManu').daterangepicker({
       		autoclose:true,
            buttonClasses: ' btn',
            ...
            $('#offersDateRangePickerManu .form-control').val( start.format('DD-MMM-YYYY') + ' / ' + end.format('DD-MMM-YYYY'));
        });
	$('#offersDateRangePickerManu').on('cancel.daterangepicker', function(ev, picker) {
...
function actionFormatter(cellvalue, options, rowObject){
	return '<a onclick=showRowData("'+options.rowId+'") class="btn btn-light-primary  btn-icon btn-hover-primary btn-sm mr-4"  data-toggle="tooltip" title=" Make it Offer"><i class="icon-lg la la-tags"></i></a>'+"&nbsp <a onclick='editPrice(\"" +options.rowId+ "\");' title='Edit' href='javascript:void(0)'class='btn btn-sm btn-bg-white btn-clean btn-icon-warning  btn-hover-warning  btn-icon mr-2 my-1 my-lg-0' > <i class='la la-pencil'></i></a>";
