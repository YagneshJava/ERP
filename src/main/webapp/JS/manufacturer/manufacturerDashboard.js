...
$(document).ready(function(){
	...
	$("#manufacturerDashboardLI").addClass('menu-item-here');
...
function quotationEditFormatter(cellvalue, options, rowObject) {
	return "<center><a onclick='getQuotationData(\"" + rowObject.quotationId + "\",\""+rowObject.addressId+ "\");' title='Edit' href='javascript:void(0)' class = 'btn btn-sm btn-bg-white btn-clean btn-icon-warning  btn-hover-warning  btn-icon mr-1 my-1 my-lg-0'><i class='la la-pencil'></i></a></center>";
}
...
function getQuotationData(quotationId,addressId){
	...
	localStorage.setItem("supplierAddressId",addressId);
	 window.location.href = "manufacturerQuotationPage";
}
