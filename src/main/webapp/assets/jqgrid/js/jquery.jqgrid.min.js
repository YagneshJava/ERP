    ...
    $.extend(!0, jgrid, {
        ...
        icons: {
            ...
            fontAwesome: {
                ...
                pager: {
                    common: "ki",
                    first: "ki-double-arrow-back",
                    prev: "ki-arrow-back",
                    next: "ki-arrow-next",
                    last: "ki-double-arrow-next"
                },
                sort: {
                    common: "fa-lg",
                    asc: "fa-sort-asc",
                        ...
                        if (jgrid.enumEditableCells.call(u, n, $(n).hasClass("jqgrid-new-row") ? "add" : "edit", function (e) {
                                ...
                                if (m[n] = e.editable, "hidden" !== e.editable) {
                                    ...
                                    g[n] = t, o.html(""), r = $.extend({}, c, {
                                        ...
                                        cm: a,
                                        iCol: d
                                    }), ("&nbsp;" === t || "&#160;" === t || 1 === t.length && 160 === t.charCodeAt(0)) && (t = ""), i = jgrid.createEl.call(u, s, r, t, !0, $.extend({}, jgrid.ajaxOptions, p.ajaxSelectOptions || {})), $(i).addClass("form-control"), o.append(i), l && $(i).width(e.dataWidth), jgrid.bindEv.call(u, i, r), "select" === s && !0 === c.multiple && void 0 === c.dataUrl && jgrid.msie && $(i).width($(i).width()), null === h && (h = d), f++
                                }
                            }), 0 < f) {
