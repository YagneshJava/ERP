...
KTUtil.ready(function() {
    ...
    // Init Admiin Quick Actions Offcanvas Panel
    if (typeof KTLayoutQuickActionsAdmin !== 'undefined') {
        KTLayoutQuickActionsAdmin.init('admin_quick_actions');
    }


        // Init Tender Quick Actions Offcanvas Panel
        if (typeof KTLayoutQuickActionsTender !== 'undefined') {
            KTLayoutQuickActionsTender.init('tender_quick_actions');
        }

          if (typeof KTLayoutQuickActionsSupplierTender !== 'undefined') {
            KTLayoutQuickActionsSupplierTender.init('supplier_tender_quick_actions');
        }
...
var KTLayoutQuickActionsAdmin = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'admin_quick_actions_close',
            toggleBy: 'admin_quick_actions_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutQuickActionsAdmin;
}
...
var KTLayoutQuickActionsTender = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'tender_quick_actions_close',
            toggleBy: 'tender_quick_actions_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutQuickActionsTender;
}
...
var KTLayoutQuickActionsSupplierTender = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'supplier_tender_quick_actions_close',
            toggleBy: 'supplier_tender_quick_actions_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutQuickActionsSupplierTender;
}
...
$('#searchBtn').click(function(){
	$('#srchHideShow').removeClass("show");
	$("#srchHideShow").addClass("d-none");
});

$(document).ready(function(){		
	$('.g-search-form').on('click', function(e) {		
		$("#srchHideShow").removeClass("d-none");
		e.stopPropagation();	
		$('.drp-buttons button').on('click', function() {		
             $('#srchHideShow').toggleClass("d-block");               
		});		
		$('.g-search-form button').on('click', function() {
			 $('#srchHideShow').removeClass("d-block");    
			$('#srchHideShow').toggleClass("d-none"); 
			$('#srchHideShow').removeClass("d-none");   
		});	
	});		
});
...
$(document).ready(function(){
            	...
            	$('#addUpdateDiv input#description, #addUpdateDiv input#quotedQty,  #addUpdateDiv button#addLineBtn').focus(function(){
                	$("#productandquantity").addClass("productandquantityhighlight");
                	$("#div_block").addClass("productandquantity-overlay");
                })	.blur(function () {
                	$("#productandquantity").removeClass("productandquantityhighlight");
                	$("#div_block").removeClass("productandquantity-overlay");
                });
            	
                $('.expandbtn i').click(function() {
                    $('#productandquantity').toggleClass('fullscreen');
                });
                ...
                $(document).keydown(function(event) { 
					  if (event.keyCode == 27) { 
					    	$("#div_block").removeClass("productandquantity-overlay");
					    	$('#productandquantity').removeClass('fullscreen');
					  }
				});
...
//$(document).keydown(function(event) { 
//					  if (event.keyCode == 27) { 
//					    	$('#kt_quick_notifications').removeClass('offcanvas-on');
