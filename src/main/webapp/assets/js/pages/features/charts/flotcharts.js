...
var KTFlotchartsDemo = function() {
	...
	var demo11 = function() {
		var data = [
            {label: "Baclofen", data: 13, color:  KTApp.getSettings()['colors']['theme']['base']["danger"]},
            {label: "Ampicillin", data: 25, color:  KTApp.getSettings()['colors']['theme']['base']["success"]},
            {label: "Dasatinib", data: 15, color:  KTApp.getSettings()['colors']['theme']['base']["primary"]},
            {label: "Calcium", data: 10, color:  KTApp.getSettings()['colors']['theme']['base']["warning"]},
            {label: "Cefuroxime", data: 8, color:  KTApp.getSettings()['colors']['theme']['base']["info"]}
        ];
