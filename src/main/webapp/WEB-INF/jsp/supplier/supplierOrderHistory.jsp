                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <div class="dropdown dropdown-inline" title="Show Search Options">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form"  id ="srchHideShow">
															...
															<button type="button" onclick="srchOrderHistory()" class="btn btn-primary font-weight-bold btn-hover-light-primary  float-right  mt-3 mt-sm-0" id="searchBtn">
															Search</button>
                                                            <!--end::Navigation-->
                                                        </div>
                                                    </div>
...
<!-- 																		end::Svg Icon -->
                                                        ...
                                                        <!--begin::Input-->
                                                        <div id='suppOrdHistDateRange' class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                                                            <span class="bullet bullet-ver h-25px d-none d-sm-flex mr-2"></span>
                            	...
                            	<div class="col-lg-2 col-xl-2 mb-5">
									...
									<div class="col-lg-2 col-xl-2 mb-5" style="display: none;">
										<!--begin::Iconbox-->
										<div class="card card-custom mb-8 mb-lg-0 bg-light-success card-shadowless gutter-b">
											<div class="card-body">
												<div class="d-flex align-items-center p-5">
													...
													<div class="d-flex flex-column">
	                                                	...
	                                                	<input type='text' class="text-dark-75 font-size-h2 font-weight-bolder mr-2" style=" border: 0;" disabled="disabled"  id="savedQtId" name="savedQtId" />
                                          			</div>
												</div>
											</div>
										</div>
									...
									<div class="col-lg-2 col-xl-2 mb-5" style="display: none;">
										<!--begin::Iconbox-->
										<div class="card card-custom mb-8 mb-lg-0 bg-light-info card-shadowless gutter-b">
											<div class="card-body">
												<div class="d-flex align-items-center p-5">
													
													<div class="d-flex flex-column">
														<p class="card-title font-weight-bolder text-info text-hover-state-dark font-size-h6 mb-4 d-block"> Representative </p>
	                                                	<input type='text' class="text-dark-75 font-size-h2 font-weight-bolder mr-2" style="border: 0;" disabled="disabled"  id="savedQtRep" name="savedQtRep" />
                                          			</div>
												</div>
											</div>
										</div>
									...
									<div class="col-lg-2 col-xl-2 mb-5" style="display: none;">
										<!--begin::Iconbox-->
										<div class="card card-custom mb-8 mb-lg-0 bg-light-warning card-shadowless gutter-b">
											<div class="card-body">
												<div class="d-flex align-items-center p-5">
													
													<div class="d-flex flex-column">
														<p class="card-title font-weight-bolder text-warning text-hover-state-dark font-size-h6 mb-4 d-block"> Reference </p>
	                                                	<input type='text' class="text-dark-75 font-size-h2 font-weight-bolder mr-2" style="border: 0;" disabled="disabled"  id="savedQtRef" name="savedQtRef" />
                                          			</div>
												</div>
											</div>
										</div>
										...
										<div class="card card-custom mb-8 mb-lg-0 bg-light-success card-shadowless gutter-b">
											<div class="card-body">
												<div class="d-flex align-items-center p-5">
													...
													<div class="d-flex flex-column">
														<p class="card-title font-weight-bolder text-success text-hover-state-dark font-size-h6 mb-4 d-block"> Final Date </p>
	                                                	<input type='text' class="text-dark-75 font-size-h2 font-weight-bolder mr-2" style="border: 0;" disabled="disabled"  id="savedFinalDate" name="savedFinalDate" />
                                          			</div>
												</div>
											</div>
										</div>
										...
										<div class="card card-custom mb-8 mb-lg-0 bg-light-info card-shadowless gutter-b">
											<div class="card-body">
												<div class="d-flex align-items-center p-5">
													...
													<div class="d-flex flex-column">
														<p class="card-title font-weight-bolder text-info text-hover-state-dark font-size-h6 mb-4 d-block"> Delivery Date </p>
	                                                	<input type='text' class="text-dark-75 font-size-h2 font-weight-bolder mr-2" style="border: 0;" disabled="disabled"  id="savedDeliveryDate" name="savedDeliveryDate" />
                                          			</div>
												</div>
											</div>
										</div>
									...
									<div class="col-lg-2 col-xl-2 mb-5" style="display: none;">
										<!--begin::Iconbox-->
										<div class="card card-custom mb-8 mb-lg-0 bg-light-danger card-shadowless gutter-b">
											<div class="card-body">
												<div class="d-flex align-items-center p-5">
													
													<div class="d-flex flex-column">
														<p class="card-title font-weight-bolder text-danger text-hover-state-dark font-size-h6 mb-4 d-block"> Quotation Type </p>
	                                                	<input type='text' class="text-dark-75 font-size-h2 font-weight-bolder mr-2" style="border: 0;" disabled="disabled"  id="quotationStatus" name="quotationStatus" />
                                          			</div>
												</div>
											</div>
										</div>
                    ...
                    <script src="${pageContext.request.contextPath}/JS/supplier/supplierOrderHistory.js?v=wewq"></script>
