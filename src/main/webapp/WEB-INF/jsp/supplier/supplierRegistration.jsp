							...
							<div class="wizard-steps">
								...
								<div class="wizard-step" data-wizard-type="step">
									<div class="wizard-wrapper">
										...
										<div class="wizard-label">
											<h3 class="wizard-title">  Home Office Licenses </h3>
											<div class="wizard-desc">  Licenses Information </div>
										</div>
									</div>
								</div>
						...
						<div class="login-form login-form-signup">
							...
							<form class="form" novalidate="novalidate" id="customerRegistrationForm">
								...
								<div class="row">
									<div class="col-xl-6">
										<div class="form-group">
											<label class="font-size-h6 font-weight-bolder text-dark"> WDA no.* </label>
											<input value="${sessionScope.userLoginDetails.getRegistrationNo()}" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" id="wdaRegistrationNo" name="wdaRegistrationNo" readonly  />
										</div>
									</div>
									<div class="col-xl-6">
										<div class="form-group">
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="row  mt-5" >
								<div class="col-lg-12">
							<!-- Delivery Address Secopn End --> 
							<div class="pb-5">

								<!--begin::Title-->
								<div class="pt-lg-0 pt-5 pb-15">
									<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"> Delivery Address </h3>
									<div class="text-muted font-weight-bold font-size-h4"> Delivery  Address Information </div>
								</div>
								<!--end::Title-->
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" value="${sessionScope.regDeliveryAddress.getPostcode()}" readonly class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6"   id="regBillingPostcode" name="addresses[0].zipCode" />
...
<%-- 										<input name="addresses[1].country"  readonly value="${sessionScope.regDeliveryAddress.getCountry()}" id="regBillingCountry" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6"> --%>
<!-- 									</div> -->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Country* </label>
						...
						<div class="row">
							<div class="col-xl-12">
								...
								<div class="form-group">
									...
									<input type="text" value="${sessionScope.regDeliveryAddress.getAddress1()}" readonly class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].address1" id="regBillingAddress1"  value="" />
								</div>
								<!--end::Input-->
							</div>
						</div>
						...
						<div class="row">	
							<div class="col-xl-6">
								...
								<div class="form-group">
									...
									<input type="text" value="${sessionScope.regDeliveryAddress.getAddress2()}" readonly class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].address2" id="regBillingAddress2"  value="" />
								</div>
								<!--end::Input-->
							</div>
							<div class="col-xl-6">
								...
								<div class="form-group">
									...
									<input type="text" value="${sessionScope.regDeliveryAddress.getAddress3()}" readonly class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].address3" id="regBillingAddress3"  value="" />
								</div>
								<!--end::Input-->
							</div>
						</div>
						...
						<div class="row" > 
							...
							<div class="col-xl-6">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].county" id="regBillingCounty"  value="${sessionScope.regDeliveryAddress.getCounty()}" />
								</div>
								<!--end::Input-->
							</div>
						</div>
			...
			<div class="form-group">
							...
							<div id="billingAddressDiv" style="display:none;"> 
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Postcode* </label>
										<div class="input-group">
											<input type="text" class="form-control h-auto py-7 px-6 border-0 font-size-h6" placeholder="Postcode" id="regPostcode" name="addresses[1].zipCode" value="${sessionScope.regDeliveryAddress.getPostcode()}"/>
											<div class="input-group-append">
							...
							<div class="row">
								<div class="col-xl-12">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Address Line 1* </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].address1" id="address1" placeholder="Address Line 1" value="${sessionScope.regDeliveryAddress.getAddress1()}" />
									</div>
									<!--end::Input-->
								</div>
							...
							<div class="row">
								<div class="col-xl-6">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Address Line 2 </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].address2" id="address2" placeholder="Address Line 2" value="${sessionScope.regDeliveryAddress.getAddress2()}" />
									</div>
									<!--end::Input-->
								</div>
								<div class="col-xl-6">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Address Line 3 </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].address3" id="address3" placeholder="Address Line 3" value="${sessionScope.regDeliveryAddress.getAddress3()}" />
									</div>
									<!--end::Input-->
								</div>
							</div>
...
<!-- 									end::Input -->
								...
								<div class="col-xl-6">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> County* </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].county" id="county" placeholder="County" value="${sessionScope.regDeliveryAddress.getCounty()}" />
									</div>
									<!--end::Input-->
								</div>
						...
						<!--end: Wizard Step 3-->
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="pt-lg-0 pt-5 pb-5">
										<h4 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"> Control Drug Licenses </h4>
									</div>
...
<!-- 														<label class="col-xl-2 col-lg-2 col-form-label"> Schedule 1  </label> -->
<!-- 														<div class="col-lg-5 col-xl-5"> -->
<!-- 															<input class="form-control" type="text" placeholder="Licence No."> -->
<!-- 														</div> -->
<!-- 														<div class="col-lg-5 col-xl-5"> -->
<!-- 													<input type="text" class="form-control" id="kt_datepicker_1" readonly="readonly" placeholder="Select Expiry Date" /> -->
<!-- 													</div> -->
<!-- 													</div> -->
...
<!-- 													<div class="separator separator-dashed mb-5"></div> -->
													...
													<div class="form-group row mb-4">
														<label class="col-xl-2 col-lg-2 col-form-label"> Schedule 2 </label>
														<div class="col-lg-5 col-xl-5">
															<input class="form-control"  id="license2" name="license2" type="text" placeholder="Licence No.">
														</div>
														<div class="col-lg-5 col-xl-5">
															<input type="text" class="form-control licenseDate" id="license2DatePicker" readonly="readonly" placeholder="Select Expiry Date" />
														</div>
													</div>
													
													<div class="separator separator-dashed mb-5"></div>
													<div class="form-group row mb-4">
														<label class="col-xl-2 col-lg-2 col-form-label"> Schedule 3 </label>
														<div class="col-lg-5 col-xl-5">
															<input class="form-control " type="text" id="license3" name="license3"  placeholder="Licence No.">
														</div>
														<div class="col-lg-5 col-xl-5">
														<input type="text" class="form-control licenseDate"  id="license3DatePicker"  readonly="readonly" placeholder="Select Expiry Date" />
													</div>
													</div>
													
													<div class="separator separator-dashed mb-5"></div>
													<div class="form-group row mb-4">
														<label class="col-xl-2 col-lg-2 col-form-label"> Schedule 4.1 </label>
														<div class="col-lg-5 col-xl-5">
															<input class="form-control " type="text" id="license41" name="license41"  placeholder="Licence No.">
														</div>
														<div class="col-lg-5 col-xl-5">
															<input type="text" class="form-control licenseDate"  id="license41DatePicker"  readonly="readonly" placeholder="Select Expiry Date" />
														</div>
													</div>		
																									
													<div class="separator separator-dashed mb-5"></div>
													<div class="form-group row mb-4">
														<label class="col-xl-2 col-lg-2 col-form-label"> Schedule 4.2 </label>
														<div class="col-lg-5 col-xl-5">
															<input class="form-control " type="text" id="license42" name="license42"  placeholder="Licence No.">
														</div>
														<div class="col-lg-5 col-xl-5">
															<input type="text" class="form-control licenseDate"  id="license42DatePicker"  readonly="readonly" placeholder="Select Expiry Date" />
														</div>
													</div>		
													...
													<div class="separator separator-dashed mb-5"></div>
													<div class="form-group row mb-4">
														<label class="col-xl-2 col-lg-2 col-form-label"> Schedule 5 </label>
														<div class="col-lg-5 col-xl-5">
															<input class="form-control " type="text" id="license5" name="license5"  placeholder="Licence No.">
														</div>
														<div class="col-lg-5 col-xl-5">
															<input type="text" class="form-control licenseDate"  id="license5DatePicker"  readonly="readonly" placeholder="Select Expiry Date" />
														</div>
													</div>											
...
<!-- 													<div class="form-group row"> -->
<!-- 														<label class="col-xl-2 col-lg-2 col-form-label"> Schedule 7 </label> -->
<!-- 														<div class="col-lg-5 col-xl-5"> -->
<!-- 															<input class="form-control " type="text" placeholder="Licence No."> -->
<!-- 														</div> -->
<!-- 														<div class="col-lg-5 col-xl-5"> -->
...
<!-- 													</div>		 -->
									...
									<!--begin::Title-->
									<div class="pt-lg-0 pt-5 pb-5">
										<h4 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"> 	Upload Home Office License </h4>
									</div>
									<!--end::Title-->
									<div class="form-group row">
										<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="separator separator-dashed my-5"></div>
									...
									<!--begin::Title-->
									<div class="pt-lg-0 pt-5 pb-5">
										<h4 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"> 	Upload WDA License </h4>
									</div>
									<!--end::Title-->
									<div class="form-group row">
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="dropzone dropzone-default" id="wdaFileDZ">
												<div class="dropzone-msg dz-message needsclick mt-2 mb-2">
													<h3 class="dropzone-msg-title">Drop files here or click to upload.</h3>
													 <span class="note needsclick">(<strong>.pdf</strong> file only.)</span>
												</div>
		...
		<script src="${pageContext.request.contextPath}/JS/supplier/supplierRegistration.js"></script>
...
<%-- 		<script src="${pageContext.request.contextPath}/assets/js/pages/crud/file-upload/dropzonejs.js"></script> --%>
        ...
        var addresses; 
        var viewCountry = "${sessionScope.regDeliveryAddress.getCountry()}";
