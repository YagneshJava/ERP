                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <h5>
                                                <a href="stockPage" class="text-dark font-weight-bold"> Stock Management </a>
                                            </h5>
                                        </li>
                                    </ul>
                                    <!--end::Page Title-->
                                                ...
                                                <div class="input-group-append d-none">
                                                    ...
                                                    <div class="dropdown dropdown-inline" title="Show Search Options">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form" id ="srchHideShow">
															...
															<button type="button" onclick="loadStock()" class="btn btn-primary font-weight-bold btn-hover-light-primary mb-3 float-right  mt-3 mt-sm-0" id="searchBtn">
															Search</button>
							        ...
							        <div class="form-group row mb-0">
							            ...
							            <div class="col-lg-7 col-xl-9">								
							                <label> Full Address </label>
												...
												<textarea style="width: 580px;" rows="1" readonly="readonly" id="fullAddress" class="form-control" placeholder="Enter your address"></textarea>
										</div>
							            </div>
...
<!--                                                 <label for="">  Select Location 222  </label> -->
...
<!--                                             </div> -->
                                            ...
                                            <div class="card-toolbar upload-download-stock">
    ...
    <script src="${pageContext.request.contextPath}/JS/supplier/stock.js"></script>
</body>
<!--end::Body-->
