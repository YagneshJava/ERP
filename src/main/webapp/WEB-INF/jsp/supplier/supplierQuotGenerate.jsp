                        ...
                        <div class="d-flex flex-column-fluid">
                            ...
                            <div class="container-fluid">
                                                    ...
                                                    <div class="dropdown dropdown-inline" title="Show Search Options">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form"  id ="srchHideShow">
                                                            ...
                                                            <div class="input-group input-icon input-icon-right mb-3">
                                                                <div id="suppCreateQtSrchDateRange" class="w-100" style="border-bottom-right-radius: 0.675rem !important; border-top-right-radius: 0.675rem !important;">
															...
															<button onclick="getQuotationList()" type="button" class="btn btn-primary font-weight-bold btn-hover-light-primary float-right    mt-3 mt-sm-0" id="searchBtn">
																Search
															</button>
                                                            <!--end::Navigation-->
                                                        </div>
                                            ...
                                            <div class="card-header flex-wrap py-5">
                                                ...
                                                <div class="bg-white effect1 rounded p-2 pr-3 pl-3 d-flex flex-grow-1 flex-sm-grow-0 quot-search-form"  style="display: none !important;">
                                                    ...
                                                    <form id="quotationSearchForm" class="form d-flex flex-sm-row flex-column flex-grow-1 flex-sm-grow-0">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div id='suppCreateQtSrchDateRange' class="d-flex align-items-center py-3 py-sm-0 px-sm-3 quot-date">
                                                            <span class="bullet bullet-ver h-25px d-none d-sm-flex mr-2"></span>
                                                ...
                                                <a href="downloadQuotationFormat" class="btn  btn-outline-info btn-hover-light-info font-size-sm mr-5">
													  <i class="icon-lg la la-file-download"></i>
													  <span class="download-quot-text"> Quotation Format</span>
													</a>
                                ...
                                <div class="row mt-0 mt-lg-4 " id="editQuotationDiv" style="display: none">
                                    ...
                                    <div class="col-xl-12">
                                        <!--begin::Card-->
                                        <div class="card card-custom card-collapsed" data-card="true" id="headerfocus">
                                                ...
                                                <div style="cursor: pointer;" data-card-tool="toggle" title="Edit Tender" class="card-title w-97">
                                                    ...
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <div class="mt-1">
                                                            ...
                                                            <span class="font-weight-bold " id="qtInfoStatus"> </span>
                                                        </div>
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="savedQtId" name="savedQtId" class="form-control form-control-lg border-3" placeholder="" disabled/>
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                    ...
                                                    <div class="col-xl-3">
                                                        <!--begin::Input-->
                                                        <div class="form-group">
                                                            <label> Representative </label> <input type="text" class="form-control form-control-lg border-3" placeholder="" id="savedQtRep" name="savedQtRep" disabled/>
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control form-control-lg date-picker border-3" placeholder="" id="savedFinalDate" name="savedFinalDate" onkeydown="return false"/>
                                                                <div class="input-group-append">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control form-control-lg date-picker border-3" placeholder="" id="savedDeliveryDate" name="savedDeliveryDate" onkeydown="return false"/>
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"> <i
																		class="la la-calendar"></i>
																	</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <div class="form-group" style="display: none">
                                                            <input type="text" class="form-control form-control-lg" placeholder="" id="quotationStatus" name="quotationStatus" />
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="card card-custom" id="productandquantity">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <!--begin::Search Form-->
                                                        <div class=" pr-9 pl-9" id = "addUpdateDiv">
                                                            <div class="row align-items-center">

                                                                <div class="col-lg-7 col-xl-7">
                                                                
                                                                <a href="" class="btn btn-success font-weight-bold mb-5 d-none" data-toggle="modal" data-target="#addproductandquantity">
                                                                Add Product and Quantity</a>
                                                                ...
                                                                <div class="row align-items-center">
                                                                        ...
                                                                        <div class="col-md-7 my-2 my-md-0" >
                                                                            <div class="form-group">
                                                                                <label> Product </label> <input type="text" class="form-control form-control-lg twitter-typeahead border-3" placeholder="" id="description" name="description">
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-md-5 my-2 my-md-0" style="display: none">
                                                                            <div class="form-group">
                                                                                <label> BNFPipCode </label> <input type="text" class="form-control form-control-lg" placeholder="" id="pipCode" name="pipCode">
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-md-3 my-2 my-md-0">
                                                                            <div class="form-group">
                                                                                <label> Quantity </label> <input type="text" class="form-control form-control-lg border-3" placeholder="" id="quotedQty" name="quotedQty" onkeypress="return isNumber(event)">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row d-none">
                                                                            ...
                                                                            <div class="col-md-9">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div></div>
                                                                                    <div class="custom-file">
                                                                                        <input type="file" class="custom-file-input" id="updateLineFile" name="lineFile" accept=".xlsx, .xls, .csv" /> <label class="custom-file-label border-3" for="customFile" id = "updateLineFile"></label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="form-group">
                                                                                    <button class="btn btn-primary btn-md px-6 font-weight-bold  mt-8" type="button" onclick="udpateQuotationLineFilePopUp()" id="updateQuotationFileBtn">Upload File</button>
                                                                                </div>
                                                                            </div>
																...
																<!-- begin : Modal -->
<!--                                                                 <div class="modal fade" id="addproductandquantity" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;" aria-modal="true"> -->
<!-- 																	<div class="modal-dialog modal-dialog-centered modal-lg" role="document"> -->
<!-- 																		<div class="modal-content"> -->
<!-- 																			<div class="modal-header"> -->
<!-- 																				<h5 class="modal-title" id="exampleModalLabel"> Add Product and Quantity</h5> -->
<!-- 																				<button type="button" class="close" data-dismiss="modal" aria-label="Close"> -->
<!-- 																					<i aria-hidden="true" class="ki ki-close"></i> -->
<!-- 																				</button> -->
<!-- 																			</div> -->
...
<!-- 																					<div class="alert alert-custom alert-light-success mb-6 p-3" role="alert"> -->
...
<!-- 				                                                                            <div class="form-group"> -->
<!-- 				                                                                                <label> Product </label>  -->
<!-- 				                                                                                <input type="text" class="form-control form-control-lg twitter-typeahead border-3" placeholder="" id="description" name="description"> -->
<!-- 				                                                                            </div> -->
<!-- 				                                                                        </div> -->
<!-- 				                                                                        <div class="col-md-4 my-2 my-md-0"> -->
<!-- 				                                                                            <div class="form-group"> -->
<!-- 				                                                                                <label> Quantity </label>  -->
<!-- 				                                                                                <input type="text" class="form-control form-control-lg border-3" placeholder="" id="quotedQty" name="quotedQty" onkeypress="return isNumber(event)"> -->
<!-- 				                                                                            </div> -->
<!-- 				                                                                        </div> -->
<!-- 				                                                                        <div class="col-md-2 my-2 my-md-0"> -->
<!-- 				                                                                            <div class="form-group"> -->
<!-- 				                                                                                <button class="btn btn-success btn-md px-6 font-weight-bold mt-7" onclick="addLine()" id="addLineBtn"> -->
<!-- 																									Add  -->
<!-- 																								</button> -->
<!-- 				                                                                            </div> -->
<!-- 				                                                                        </div> -->
...
<!-- 																</div> -->
                                                        ...
                                                        <div class="card-body" id="quotationGridtable">
                            ...
                            <i aria-hidden="true" class="ki ki-close"></i>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-control-lg border-3" id="representative" name="representative" autocomplete="off">
                                    <option value="">Select Rep</option>
                                                        ...
                                                        <!--                                         <input type="text" class="form-control form-control-lg" id="reference" name="reference"  placeholder="" required  autocomplete="off"/> -->
                                                        <!--                                     </div> -->
                                                        <!--                                     end::Input -->
                                                        <!--                                 </div> -->
                                                        ...
                                                        <div class="col-xl-3">
                                                            ...
                                                            <div class="form-group">
                                                                <label>  Final Date  </label>
                                                                <div class="input-group date">
                                                                    <input type="text" class="form-control date-picker border-3" id="finalUploadDate" name="finalUploadDate" placeholder="Select date" autocomplete="off" onkeydown="return false"/>
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                    <i class="la la-calendar-check-o"></i>
                                                        ...
                                                        <div class="col-xl-3">
                                                            ...
                                                            <div class="form-group">
                                                                <label>  Delivery Date  </label>
                                                                <div class="input-group date">
                                                                    <input type="text" class="form-control date-picker  border-3" id="deliveryDate" name="deliveryDate" placeholder="Select date" autocomplete="off" onkeydown="return false"/>
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                    <i class="la la-calendar-check-o"></i>
                                                </span>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!--                                         <input type="text" class="form-control form-control-lg" placeholder="" name="quotationType" id="quotationType" autocomplete="off"/> -->
                                                        <!--                                     </div> -->
                                                        <!--                                     end::Input -->
                                                        <!--                                 </div> -->
                                                        ...
                                                        <div class="col-xl-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div></div>
                                                                <div class="custom-file">
                                                                    <input type="file" class=" form-control custom-file-input form-control-lg  border-3" id="lineFile" name="lineFile" accept=".xlsx, .xls, .csv" />
                                                                    <label class="custom-file-label  border-3" for="customFile" id="lineFielLabel">   </label>
                                                                </div>
                                                            </div>
                                                            <!--end::Input-->
                                                        ...
                                                        <div class="col-xl-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-control-lg  border-3" id="location" name="addressId" autocomplete="off">
                                    </select>
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
                                                        ...
                                                        <div class="col-xl-4">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control  border-3" disabled="disabled" rows="1" id="fullAddress"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-secondary font-weight-bold" onclick="resetQtModal()">  Reset   </button>
        ...
        <div class="modal fade" id="ViewCustomerHistoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeXl" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Customer History</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<i aria-hidden="true" class="ki ki-close"></i>
					</button>
                    </div>
                    <div class="modal-body">
                        <table id="customerHistoryDatatable" class="table table-hover table-checkable" style="margin-top: 13px !important">
                        </table>
                    </div>
                    <!-- <div class="modal-footer">
...
<!-- 					<button type="button" class="btn btn-primary font-weight-bold">Save changes</button> -->
	...
	<!--end::Customer History  Modal-->
        ...
        <script src="${pageContext.request.contextPath}/JS/supplier/supplierQTGenerator.js?v=17721"></script>
