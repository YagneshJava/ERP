                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <h5>
                                                <a href="supplierOrderConfirmation" class="text-dark font-weight-bold"> Order </a>
                                            </h5>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
...
<!--                             </div> -->
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container-fluid">
                            <input type="hidden" id="manufacturerId" name="manufacturerId" value="${sessionScope.userCompanyDetails.getId()}">
                            <!--begin::Content-->
                                                    ...
                                                    <div class="dropdown dropdown-inline" title="Show Search Options">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form" id ="srchHideShow">
                                                            ...
                                                            <div class="input-group input-icon input-icon-right mb-3">
                                                                <div id="manuOrdSrchDateRange" class="w-100" style="border-bottom-right-radius: 0.675rem !important; border-top-right-radius: 0.675rem !important;">
                                            ...
                                            <div class="bg-white effect1 rounded p-2 pr-3 pl-3 d-flex flex-grow-1 flex-sm-grow-0">
                                                ...
                                                <form id="quotationSearchForm" class="form d-flex flex-sm-row flex-column flex-grow-1 flex-sm-grow-0">
                                                  ...
                                                  <!--begin::Input-->
                                                    ...
                                                    <!--begin::Input-->
                                                    <div id='manuOrdSrchDateRange' class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                                                        <span class="bullet bullet-ver h-25px d-none d-sm-flex mr-2"></span>
...
<!-- 	                                                	<input type="text" class="text-white font-size-h4 font-weight-bolder mr-2" style="border: 0;background-color: #f75163;" disabled="disabled" value=""> -->
<!--                                           			</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
<!-- 										</div> -->
...
<!-- 													<div class="d-flex flex-column" style="line-height: 0; margin-bottom: -12px;"> -->
<!-- 														<p class="card-title font-weight-bolder text-white text-hover-state-dark  mb-4 d-block"> Customer Address </p> -->
<!-- 	                                                	<input type="text" class="text-white font-size-h4 font-weight-bolder mr-2" style="border: 0;background-color: #f75163;" disabled="disabled" value=""> -->
<!--                                           			</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
...
<!--                             </div> -->
					...
					<div class="sidebar-content flex-column-fluid pb-10 pt-9 px-5 px-lg-10">
						...
						<div class="card card-custom bg-light-blue gutter-b">
							...
							<div class="card-body my-2">	
	                            ...
	                            <input type="text" class="text-dark-75 font-weight-bolder font-size-h2 mr-2 w-100 bg-transparent" style="border: 0;background-color: #f75163;" disabled="disabled" value="">
                           </div>
							<!--end::Body-->
						</div>
						<!--end::Stats Widget 20-->
                    ...
                    <div style="-webkit-box-shadow: none; box-shadow: none;" class="card card-custom">
                        ...
                        <div class="card-header card-header-tabs-line">
                            ...
                            <div class="card-title">
                                <h3 class="card-label"> Credit Modal </h3>
                            </div>
                                                ...
                                                <div class="d-flex flex-column flex-root">
                                                    <div class="card card-custom card-fit card-border mr-5">
                                                        <div class="card-body py-lg-0 pt-2">
                                                            ...
                                                            <p id="companyVatNumber">GB299336940</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column flex-root">
                                                    <div class="card card-custom card-fit card-border mr-5">
                                                        <div class="card-body py-lg-0 pt-2">
                                                            ...
                                                            <p id="companyRegNumber">10470454</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column flex-root ">
                                                    <div class="card card-custom card-fit card-border mr-5">
                                                        <div class="card-body py-lg-0 pt-2">
                                                            ...
                                                            <p id="commonDescription">Moderate Risk</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column flex-root ">
                                                    <div class="card card-custom card-fit card-border mr-5">
                                                        <div class="card-body py-lg-0 pt-2">
                                                            ...
                                                            <p id="latestRatingChangeDate">2021-08-29T05:43:11Z</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column flex-root ">
                                                    <div class="card card-custom card-fit card-border mr-5">
                                                        <div class="card-body py-lg-0 pt-2">
                                                            ...
                                                            <p id="shareHolderName">MISS NEGIN NIAZI,</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex flex-column flex-root ">
                                                    <div class="card card-custom card-fit card-border mr-5">
                                                        <div class="card-body py-lg-0 pt-2">
                                                            ...
                                                            <p id="directorName">Miss Negin   Niazi,</p>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script src="${pageContext.request.contextPath}/JS/manufacturer/manufacturerOrder.js"></script>
