                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <h5>
                                                <a href="stockPage" class="text-dark font-weight-bold"> Stock </a>
                                            </h5>
                                        </li>
                                    </ul>
                                    <!--end::Page Title-->
                                    ...
                                    <div class="quick-search quick-search-inline mb-10 w-28" id="kt_quick_search_inline">
                                        ...
                                        <form method="get" class="quick-search-form g-search">
                                            <div class="input-group rounded bg-white input-group-lg g-search-box">
                                                ...
                                                <input type="text" class="form-control h-40px search-form pl-3" placeholder="Search Product..." id = "srchMain">
                                                <div class="input-group-append d-none">
                                                    ...
                                                    <div class="dropdown dropdown-inline" title="Show Search Options">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form" id ="srchHideShow">
															...
															<button type="button" onclick="loadStock()" class="btn btn-primary font-weight-bold btn-hover-light-primary  float-right  mt-3 mt-sm-0"  id="searchBtn">
															Search</button>
...
<!--                                                             <div class="input-group mb-3"> -->
<!--                                                                 <textarea class="form-control" disabled="disabled" rows="1" id="fullAddress" style="height: 60px;"></textarea> -->
<!--                                                             </div> -->
                                                            <!--end::Navigation-->
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-header py-5">
                                            <div class="bg-white effect1 rounded p-2 pr-3 pl-3 d-flex flex-grow-1 flex-sm-grow-0" style="display: none !important;">
                                                ...
                                                <button type="button" onclick="loadStock()" class="btn btn-primary font-weight-bold btn-hover-light-primary   mt-3 mt-sm-0">
							            ...
							            <div class="col-lg-3">
											...
											<select class="form-control form-control-md" id="location" name="addressId" autocomplete="off"></select>
							            </div>
							            <div class="col-lg-9">								
							                <label> Full Address </label>
							                	<div class="input-group"> 
												<textarea style="width: 390px; height: 38px;" rows="0" readonly="readonly" id="fullAddress" class="form-control" placeholder="Enter your address"></textarea>
										</div>
							            </div>
...
<!--                                             </div> -->
                                            <div class="card-toolbar">
                                                <a href="#" data-toggle="modal" data-target="#UploadStockModal" class="btn btn-info font-weight-bolder font-size-sm mr-3" onClick = "dropZoneFunction()"> Upload Stock </a>
                                                <a href="downloadStockFormat" class="btn btn-light-info font-weight-bolder font-size-sm">
                                                    <i class="icon-lg la la-download"></i> Download Stock Format </a>
                                            </div>
                                        </div>
                                        <!--begin::Header-->
                                        <!--end::Header-->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="dropzone dropzone-default" id="kt_dropzone_1">
                                    <div class="dropzone-msg dz-message needsclick">
                                        <h3 class="dropzone-msg-title">Click here to upload Stock List.</h3>
    ...
    <div class="modal fade" id="UploadStockModal" tabindex="-1" role="dialog" aria-labelledby="UploadStockModal" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                    ...
                    <form class="form" id="offerForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                ...
                                <div class='input-group' id='kt_daterangepicker_Mine'>
                            ...
                            <div class="col-xl-4 pl-0 text-center">
    ...
    <script src="${pageContext.request.contextPath}/JS/manufacturer/mfrStock.js"></script>
</body>
<!--end::Body-->
