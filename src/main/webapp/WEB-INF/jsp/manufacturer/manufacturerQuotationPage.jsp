...
<head>
    ...
    <base href="">
    <meta charset="utf-8" />
    <title> Manufacturer Quotation </title>
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <h5>
                                                <a href="" class="text-dark font-weight-bold">  Quotation </a></h5>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline" title="Show Search Options">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form" id ="srchHideShow">
                                                            ...
                                                            <div class="input-group input-icon input-icon-right mb-3">
                                                                <div id="manufacturerDateRangePicker" class="w-100" style="border-bottom-right-radius: 0.675rem !important; border-top-right-radius: 0.675rem !important;">
...
<!-- 															<div class="input-group mb-3"> -->
<!-- 																<select class="form-control form-control-md" id="location" name="addressId" autocomplete="off"> -->
<!-- 																	<option value="" selected="">Select Location</option> -->
<!-- 																</select> -->
<!--                                                             </div> -->
                                                            
<!--                                                             <div class="input-group mb-3"> -->
<!--                                                                 <textarea style="width: 390px; height: 60px;" rows="0" readonly="readonly" id="fullAddress" class="form-control" placeholder="Enter your address"></textarea> -->
<!--                                                             </div> -->
						...
						<!--end::Global Search-->
                                       ...
                                       <div class="card-header flex-wrap py-5 justify-content-end">
                                            <div class="mt-5 bg-white effect1 rounded p-2 pr-3 pl-3 p-sm-1 pr-sm-1 pl-sm-1 d-flex flex-grow-1 flex-sm-grow-0 h-50" style="display: none !important;">
                                                ...
                                                <form id="quotationSearchForm" class="form d-flex flex-sm-row flex-column flex-grow-1 flex-sm-grow-0">
                                                    ...
                                                    <!--begin::Input-->
                                                    <div id='manufacturerDateRangePicker' class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                                                        <span class="bullet bullet-ver h-25px d-none d-sm-flex mr-2"></span>
                               ...
                               <!--end:: Content 123 -->
                               <div class="mb-0 r-mt-0 r-form-w mt-0 mt-xs-5 mt-sm-0">
							        ...
							        <div class="form-group row mb-0">
							            ...
							            <div class="col-lg-9">								
							                <label> Full Address </label>
												...
												<textarea style="width: 390px; height: 38px;" rows="0" readonly="readonly" id="supplierFullAddress" class="form-control" placeholder="Enter your address"></textarea>
										</div>
							            </div>
...
<!-- 															<label class="mr-3 mb-0 "> Full Address </label> -->
                               ...
                               <!--end:: Content 123 -->
                                            ...
                                            <div class="inline-box d-none">
                                                <!--begin::Input-->
                                                <label for="" class="p-r p-t">  Select Location  </label>
...
<!--                                                     <a type="button" class="btn btn-info" id="downloadQuotation"> Download </a> -->
<!--                                                     <a data-toggle="modal" data-target="#uploadQuotationModal" class="btn btn-primary font-weight-bolder font-size-sm"> Upload Quotation </a> -->
                                                </div>
...
<!--                                             end::Svg Icon -->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M4.3618034,11.2763932 L4.8618034,10.2763932 C4.94649941,10.1070012 5.11963097,10 5.30901699,10 L15.190983,10 C15.4671254,10 15.690983,10.2238576 15.690983,10.5 C15.690983,10.5776225 15.6729105,10.6541791 15.6381966,10.7236068 L15.1381966,11.7236068 C15.0535006,11.8929988 14.880369,12 14.690983,12 L4.80901699,12 C4.53287462,12 4.30901699,11.7761424 4.30901699,11.5 C4.30901699,11.4223775 4.32708954,11.3458209 4.3618034,11.2763932 Z" fill="#000000" opacity="0.3"/>
            ...
            <div class="sidebar sidebar-right d-flex flex-row-auto flex-column" id="kt_sidebar" style="display: none !important">
				...
				<div class="card card-custom bg-light-success gutter-b d-non">
							<!--begin::Body-->
    ...
    <script src="${pageContext.request.contextPath}/JS/manufacturer/manufacturerQuotation.js?v=123456"></script>
