...
<head>
		...
		<base href="">
		<meta charset="utf-8" />
		<title> Manufaturer Dashboard </title>
										...
										<div class="card card-custom gutter-b">
											<div class="card-header">
												<div class="card-title">
													<h3 class="card-label font-weight-bolder text-dark">Ordered & Won</h3>
												</div>
											</div>
											<div class="card-body">
												<!--begin::Chart-->
...
<!-- 											<div class="card-header"> -->
<!-- 												<div class="card-title"> -->
<!-- 													<h3 class="card-label">Quotation Status</h3> -->
<!-- 												</div> -->
<!-- 											</div> -->
<!-- 											<div class="card-body"> -->
<!-- 												begin::Chart -->
...
<%-- 		<script src="${pageContext.request.contextPath}/assets/js/pages/features/charts/apexcharts.js"></script> --%>
		...
		<script src="${pageContext.request.contextPath}/JS/manufacturer/manufacturerDashboard.js"></script>
