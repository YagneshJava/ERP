<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed sidebar-enabled aside-enabled aside-fixed aside-minimize-hoverable aside-minimize">
                                                ...
                                                <div class="card card-custom">
                                                    ...
                                                    <div class="card-header py-3">
                                                        <div class="card-title align-items-start flex-column">
                                                            ...
                                                            <span class="text-muted font-weight-bold font-size-sm mt-1"> Change your account password
	                                                     </span>
                                                        </div>
                                                        <div class="card-toolbar">
                                                            <button type="submit" class="btn btn-success disabled mr-2">Save Changes</button>
                                                                ...
                                                                <div class="my-5">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="password" name="currentPassword" id="currentPassword" class="form-control form-control-lg border-2 " placeholder="Current password" />
                                                                            <span toggle="#currentPassword" class="fa fa-fw fa-eye field-icon toggle-password mt-3"></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label text-alert">New Password</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="password" name="newPassword" id="newPassword" class="form-control form-control-lg border-2" placeholder="New password" />
                                                                            <span toggle="#newPassword" class="fa fa-fw fa-eye field-icon toggle-password mt-3"></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label text-alert">Confirm Password</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="password" name="confirmPassword" id="confirmPassword" class="form-control form-control-lg border-2" placeholder="Confirm password" />
                                                                            <span toggle="#confirmPassword" class="fa fa-fw fa-eye field-icon toggle-password mt-3"></span>
                                                                        </div>
                                                                    </div>
        ...
        <script src="${pageContext.request.contextPath}/JS/profile/profileChangePassword.js"></script>
