...
<!-- 																	</span> -->
										...
										<h4><label  class = "pr-5 mt-4">Total</label></h4>
												<div class="input-group text-right rounded"
													...
													<input type="text" class="form-control form-control-lg" id="orderTotal" name="orderTotal" disabled="disabled">
...
<jsp:include page="../footer.jsp"></jsp:include>
	...
	<script src="${pageContext.request.contextPath}/JS/customer/offer.js"></script>	
