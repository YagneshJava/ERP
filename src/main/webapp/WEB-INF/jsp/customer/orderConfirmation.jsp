...
<body id="kt_body"
	...
	<div class="d-flex flex-column flex-root bg-color">
		...
		<!--begin::Global Search-->
							<div class="quick-search quick-search-inline mb-10 w-28"
								id="pendingOrderSearchDiv">
								<!--begin::Form-->
									...
									<div class="input-group rounded bg-white input-group-lg g-search-box">
										<div class="input-group-prepend">
											<span class="input-group-text"> <i
												class="flaticon2-search-1 icon-md"></i>
											</span>
										</div>
										<input type="text"
											class="form-control h-40px search-form pl-3"
											placeholder="Search..." id="srchMain">
										<div class="input-group-append">
											<!--begin::Dropdown-->
											<div class="dropdown dropdown-inline"
												title="Show Search Options">
												<a href="#"
													class="btn btn-icon ml-3 h-40px w-40px flex-shrink-0"
													data-toggle="dropdown" aria-haspopup="true"
													aria-expanded="false"> <svg
														xmlns="http://www.w3.org/2000/svg" width="24" height="24"
														viewBox="0 0 24 24" style="fill: #73737c;">
                                                                <path
                                                            ...
                                                            </svg> <!-- <span class="svg-icon svg-icon-2x"> -->
												...
												<div
													class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form"  id ="srchHideShow">
													<!--begin::Navigation-->
													...
													<div class="input-group mb-3">
														...
														<input type="text" id="srchQuotationId"
															name="srchQuotationId"
															class="form-control border-2 font-weight-bold pl-2"
													...
													<div class="input-group mb-3 d-none">
														...
														<input type="text" class="form-control border-2 pl-3"
													...
													<div class="input-group mb-3">
														<select id="srchDateType" name="srchDateType"
															style="width: auto"
													...
													<div class="input-group input-icon input-icon-right mb-3">
														<div id="custOrdDateRange" class="w-100"
															style="border-bottom-right-radius: 0.675rem !important; border-top-right-radius: 0.675rem !important;">
															<input id="srchStartEndDate" type="text"
																class="form-control border-2 font-weight-bold pl-2"
																placeholder="From Date &amp; To Date"
																data-toggle="modal" aria-haspopup="true"
																aria-expanded="false" data-target="#subheader7Modal"
																readonly="readonly"> <span> <i
																class="icon-lg la la-calendar"></i>
															</span>
														</div>
													</div>

													<button type="button" onclick="getConfirmedQTList()"
														class="btn btn-primary font-weight-bold btn-hover-light-primary  float-right  mt-3 mt-sm-0">
														Search</button>
													<!--end::Navigation-->
												</div>
											</div>
								...
								<div
									...
									<div class="quick-search-wrapper scroll ps" data-scroll="true"
										data-height="350" data-mobile-height="200"
...
<ul class="nav nav-bold nav-pills" id="myTab" role="tablist">
															<li class="nav-item">
																<a class="nav-link active" id="orderTab" data-toggle="tab" href="javascript:void(0)">
																	<span class="nav-icon">
															...
															<li class="nav-item">
																<a class="nav-link" id="orderHistoryTab" data-toggle="tab" href="javascript:void(0)" onclick="getCustomerOrderHistory()"  aria-controls="supplier">
																	<span class="nav-icon">
																		<i class="icon-xl la la-history"></i>
																	</span>
																	<span id = "customerChatNotificationTab" class="label label-sm label-light-danger label-rounded font-weight-bolder position-absolute top-0 right-0 mt-1 mr-1 d-none" ></span>
												...
												<table class="table  table-hover  table-checkable nowrap"
													...
													<thead>
														<tr class="text-left">
															...
															<th>Final Date</th>
															<th>Delivery Date</th>
															<th class="pr-0 text-left">Action</th>
														</tr>
													</thead>
												</table>
											</div>
...
<!-- 										begin::Iconbox -->
<!-- 										<div -->
<!-- 											class="card card-custom  bg-success card-stretch gutter-b"> -->
<!-- 											<div class="card-body"> -->
<!-- 												<div class="d-flex align-items-center"> -->

<!-- 													<div class="d-flex flex-column" -->
<!-- 														style="line-height: 0; margin-bottom: -12px;"> -->
<!-- 														<p -->
<!-- 															class="card-title font-weight-bolder text-white text-hover-state-dark  mb-4 d-block"> -->
<!-- 															Quotation ID</p> -->
<!-- 														<input type="text" -->
<!-- 															class="text-white font-size-h4 font-weight-bolder mr-2 w-100" -->
<!-- 															style="border: 0; background-color: #14c4bc;" -->
<!-- 															disabled="disabled" id="savedQtId" name="savedQtId"> -->
<!-- 													</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
<!-- 										</div> -->
...
<!-- 														<input type="text" -->
<!-- 															class="text-white font-size-h4 font-weight-bolder mr-2 w-100" -->
<!-- 															style="border: 0; background-color: #8c53f7;" -->
<!-- 															disabled="disabled" id="savedQtRep" name="savedQtRep"> -->
<!-- 													</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
<!-- 										</div> -->
...
<!-- 														<input type="text" -->
<!-- 															class="text-white font-size-h4 font-weight-bolder mr-2 w-100" -->
<!-- 															style="border: 0; background-color: #f75163;" -->
<!-- 															disabled="disabled" id="savedQtRef" name="savedQtRef"> -->
<!-- 													</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
<!-- 										</div> -->
...
<!-- 										begin::Iconbox -->
<!-- 										<div -->
<!-- 											class="card card-custom  bg-warning card-stretch gutter-b"> -->
<!-- 											<div class="card-body"> -->
<!-- 												<div class="d-flex align-items-center"> -->
...
<!-- 														<input type="text" -->
<!-- 															class="text-white font-size-h4 font-weight-bolder mr-2 w-100" -->
<!-- 															style="border: 0; background-color: #ffa82d;" -->
<!-- 															disabled="disabled" id="savedFinalDate" -->
<!-- 															name="savedFinalDate"> -->
<!-- 													</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
...
<!-- 															class="text-white font-size-h4 font-weight-bolder mr-2 w-100" -->
<!-- 															style="border: 0; background-color: #8c53f7;" -->
<!-- 															disabled="disabled" id="savedDeliveryDate" -->
<!-- 															name="savedDeliveryDate"> -->
<!-- 													</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
<!-- 										</div> -->
...
<!-- 													<div -->
<!-- 														class="d-flex text-center supplier_quoted align-center" -->
<!-- 														style="line-height: 0; margin-bottom: -12px; padding: 0 !important;"> -->


<!-- 														<span -->
<!-- 															class="card-title font-weight-bolder text-white font-size-h2 mb-2 d-block b-color-white mr-5" -->
<!-- 															id="totalSupplierQuotedCount" -->
<!-- 															style="border-radius: 0.675rem !important; margin-top: -6px;"> -->
<!-- 															0 </span> <span -->
<!-- 															class="font-weight-bolder font-size-h6 m-0 text-white"> -->
<!-- 															Supplier Quoted </span> -->


<!-- 																												<p class="card-title font-weight-bolder text-white text-hover-state-dark  mb-4 d-block"> Quotation Type </p> -->
<!-- 															                                                	<input type="text" class="text-white font-size-h4 font-weight-bolder mr-2" style="border: 0;background-color: #f75163;" disabled="disabled" id="savedQtType" name="savedQtType"> -->
<!-- 													</div> -->
<!-- 												</div> -->
<!-- 											</div> -->
<!-- 										</div> -->
...
<div class="row mt-0 mt-lg-4 " id="orderHistoryDataDiv" style="display: none">
								...
								<div class="card card-custom bg-light-success gutter-b">
									...
									<div class="card-body my-2">
										<p class="card-title font-weight-bolder text-success text-hover-state-dark font-size-h6 mb-4 d-block"> Supplier Quoted </p>
														...
														<span class="text-dark-75 font-weight-bolder font-size-h2 mr-2 w-100 bg-transparent" 
																id="totalSupplierQuotedCount" > 	0 </span>         			
									</div>
									<!--end:: Body-->
								</div>
								<!--end: Stats:Widget 19-->
	...
	<script
		src="${pageContext.request.contextPath}/JS/customer/confirmOrder.js?v=wewq"></script>
		<script src="${pageContext.request.contextPath}/JS/customer/customerOrderHistoryData.js?v=wewq"></script>
	<!--end::Page Scripts-->
