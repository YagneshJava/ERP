								...
								<input type="hidden" id="custId" name="custId" value="${sessionScope.userCompanyDetails.getId()}">
										...
										<div class="card card-custom gutter-b">
											<div class="card-header">
												<div class="card-title">
													<h3 class="card-label font-weight-bolder text-dark">Purchases & Savings</h3>
												</div>
											</div>
											<div class="card-body">
												<!--begin::Chart-->
												<div id="CustomerPurchaseAndSavingChart"></div>
												<!--end::Chart-->
											</div>
										</div>
										<!--end::Card-->
                                   ...
                                   <div class="col-xl-6">
										...
										<div class="card card-custom gutter-b">
											<div class="card-header">
												<div class="card-title">
													<h3 class="card-label font-weight-bolder text-dark">Quoted & Ordered Lines</h3>
												</div>
											</div>
											<div class="card-body">
												<!--begin::Chart-->
												<div id="CustomerQuatedAndOrderChart"></div>
												<!--end::Chart-->
											</div>
										</div>
										<!--end::Card-->
								...
								<div class="row">
									 ...
									 <div class="col-xl-4">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body">
												<!--begin::Chart-->
												<div id="CustomerOrderStatusChart"></div>
												<!--end::Chart-->
											</div>
										</div>
										<!--end::Card-->
...
<%-- 		<script src="${pageContext.request.contextPath}/assets/js/pages/features/charts/apexcharts.js"></script> --%>
		<script src="${pageContext.request.contextPath}/JS/customer/customerDashboard.js"></script>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#customerDashboardLI").addClass('menu-item-here');
			});
		</script>
