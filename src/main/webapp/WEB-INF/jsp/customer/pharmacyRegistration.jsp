				...
				<div class="login-content flex-column-fluid d-flex flex-column p-10">
								...
								<div class="row">
									<div class="col-xl-6">
										<div class="form-group">
											...
											<input value="${sessionScope.userLoginDetails.getRegistrationNo()}" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" id="gphcregistrationNo" name="gphcregistrationNo" readonly  />
										</div>
									</div>
									<div class="col-xl-6">
										<div class="form-group">
					...
					<!--begin::Title-->
									<div class="pt-lg-0 pt-5 pb-5">
										<h4 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"> 	Upload GPHC License* </h4>
									</div>
									<!--end::Title-->
									<div class="form-group row">
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="dropzone dropzone-default" id="gphcFileDZ">
						...
						<div class="row">
							<div class="col-xl-12">
								...
								<div class="form-group">
									...
									<input type="text" value="${sessionScope.regDeliveryAddress.getAddressLine1()}" readonly class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].address1" id="regBillingAddress1"  value="" />
								</div>
								<!--end::Input-->
							</div>
						</div>
						...
						<div class="row">	
							<div class="col-xl-6">
								...
								<div class="form-group">
									...
									<input type="text" value="${sessionScope.regDeliveryAddress.getAddressLine2()}" readonly class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].address2" id="regBillingAddress2"  value="" />
								</div>
								<!--end::Input-->
							</div>
							<div class="col-xl-6">
								...
								<div class="form-group">
									...
									<input type="text" value="${sessionScope.regDeliveryAddress.getAddressLine3()}" readonly class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].address3" id="regBillingAddress3"  value="" />
								</div>
								<!--end::Input-->
							</div>
						</div>
						...
						<div class="row" > 
							<div class="col-xl-6"><!-- style = "display: none" -->
								...
								<div class="form-group" >
									...
									<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[0].city" id="regBillingCity"  value="${sessionScope.regDeliveryAddress.getTown()}" />
								</div>
								<!--end::Input-->
							</div>
							<div class="col-xl-6">
			...
			<div class="form-group">
							...
							<div class="row">
								<div class="col-xl-12">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Address Line 1* </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].address1" id="address1" placeholder="Address Line 1" value="${sessionScope.regDeliveryAddress.getAddressLine1()}" />
									</div>
									<!--end::Input-->
								</div>
							...
							<div class="row">
								<div class="col-xl-6">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Address Line 2 </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].address2" id="address2" placeholder="Address Line 2" value="${sessionScope.regDeliveryAddress.getAddressLine2()}" />
									</div>
									<!--end::Input-->
								</div>
								<div class="col-xl-6">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Address Line 3 </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].address3" id="address3" placeholder="Address Line 3" value="${sessionScope.regDeliveryAddress.getAddressLine3()}" />
									</div>
									<!--end::Input-->
								</div>
							</div>
...
<!-- 									begin::Input -->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark"> Town </label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].city" id="city" placeholder="Town" value="${sessionScope.regDeliveryAddress.getTown()}" />
									</div>
<!-- 									end::Input -->
								</div>
								<div class="col-xl-6">
...
<!-- 									<div class="form-group"> -->
<!-- 										<label class="font-size-h6 font-weight-bolder text-dark"> Town </label> -->
<%-- 										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="addresses[1].town" id="town" placeholder="Town" value="${sessionScope.regDeliveryAddress.getTown()}" /> --%>
<!-- 									</div> -->
<!-- 									end::Input -->
<!-- 								</div> -->
...
<!-- 		</div> -->
		...
		<script src="${pageContext.request.contextPath}/JS/customer/pharmacyRegistration.js"></script>
