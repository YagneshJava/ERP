							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									...
									<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<h5>
											<a href="marketPricePage" class="text-dark font-weight-bold my-1 mr-5">Market Price </a>
											</h5>
											</li>
                                                    ...
                                                    <div class="dropdown dropdown-inline" title="Show Search Options">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right p-10 g-search-form"  id ="srchHideShow">
                                                            ...
                                                            <div class="input-group input-icon input-icon-right mb-3">
                                                                <div id="kt_daterangepicker_2" class="w-100" style="border-bottom-right-radius: 0.675rem !important; border-top-right-radius: 0.675rem !important;">
															...
															<button type="button" onclick="offerFilter()" class="btn btn-primary font-weight-bold btn-hover-light-primary  float-right  mt-3 mt-sm-0">
															Search</button>
                                                            <!--end::Navigation-->
                                                        </div>
                                                    </div>
...
<!-- 											<div class="bg-white effect1 rounded p-2 pr-3 pl-3 d-flex flex-grow-1 flex-sm-grow-0" style="display: none;"> -->
...
<!-- 																		end::Svg Icon -->
<!-- 																	</span> -->
<!-- 																	<input type="text" id="srchProduct" name="srchProduct" class="form-control border-0 font-weight-bold pl-2 twitter-typeahead" placeholder="Search roduct" /> -->
<!-- 																</div> -->
<!-- 																end::Input -->



<!-- 																<button type="button" onclick="loadMarketPriceList()" class="btn btn-primary font-weight-bold btn-hover-light-primary   mt-3 mt-sm-0"> -->
...
<!-- 										end::Header -->
										...
										<div class="card-body">
											<div class="table-responsive">
												<table class="table  table-hover  table-checkable nowrap" id="marketPriceDataTable">
													<thead>
														<tr class="text-left">
															<th>Pip Code</th>
															<th>Product</th>
...
<!-- 										end::Body -->
	...
	<script src="${pageContext.request.contextPath}/assets/js/menu-scripts.bundle.js"></script>		<!--begin::Page Scripts(used by this page)-->
	...
	<script src="${pageContext.request.contextPath}/JS/customer/marketPrice.js?v=wewq"></script>	
	<!--end::Page Scripts-->
